...
app.post("/add-user-to-group", async (req, res) => {
  ...
  if (!userId || !groupName) {
    return res.status(400).json({ error: "userId e groupName obrigatórios" });
  }
...
app.post("/send-to-group", async (req, res) => {
  const { groupName, titulo, mensagem } = req.body;
